...
def trim_rows( sorted_rows, start_regex = None, end_regex = None ):
    '''
    Return list ('insnha_amount', 'inspriv_amount'): insured amounts in dollars.
